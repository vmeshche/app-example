...
('a0000001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Keynote',   '#007AFF', 'star',         1),
('a0000001-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'Workshop',  '#FF9500', 'wrench',       2),
('a0000001-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'Talk',      '#5856D6', 'message-square', 3),
('a0000001-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'Panel',     '#34C759', 'users',        4),
('a0000001-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001', 'Networking','#FF2D55', 'heart',        5);

-- ── Rooms / Stages ──────────────────────────────────────────
INSERT INTO rooms (id, event_id, name, type, capacity, floor, description) VALUES
('b0000001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Main Stage',       'stage',     1200, '1F', 'Main keynote hall with 4K LED wall'),
('b0000001-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'Innovation Stage', 'stage',      400, '1F', 'Intimate stage for product demos'),
('b0000001-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'Design Stage',     'stage',      300, '1F', 'Focused on design and UX topics'),
('b0000001-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'Security Stage',   'stage',      250, '2F', 'Security and infrastructure talks'),
('b0000001-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001', 'Engineering Stage','stage',      350, '2F', 'Engineering deep dives'),
('b0000001-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000001', 'Community Stage',  'stage',      200, '2F', 'Community and open source'),
('b0000001-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000001', 'Workshop A',       'workshop',   60,  '1F', 'Hands-on workshop room'),
('b0000001-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000001', 'Workshop B',       'workshop',   60,  '1F', 'Hands-on workshop room'),
('b0000001-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000001', 'Expo Hall',        'booth',     null, '1F', 'Exhibition and sponsor booths'),
('b0000001-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 'Food Court',       'food',      null, '1F', 'Dining area with food trucks'),
('b0000001-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000001', 'Registration',     'entrance',  null, '1F', 'Check-in and badge pickup');
...
('c0000001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000001', 'Main Stage',     'stage',        '#007AFF', 28,  18,  200, 108),
('c0000001-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000002', 'Innovation Stage','stage',      '#5856D6', 246, 18,  120, 78),
('c0000001-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000003', 'Design Stage',   'stage',        '#FF2D55', 246, 112, 120, 78),
('c0000001-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000007', 'Workshop A',     'workshop',     '#FF9500', 28,  148, 90,  68),
('c0000001-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000008', 'Workshop B',     'workshop',     '#FF9500', 128, 148, 90,  68),
('c0000001-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000009', 'Expo Hall',      'expo',         '#8E8E93', 200, 210, 170, 90),
('c0000001-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000010', 'Food Court',     'food',         '#34C759', 28,  240, 150, 60),
('c0000001-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000011', 'Registration',   'registration', '#5AC8FA', 28,  320, 340, 40),
('c0000001-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000004', 'Security Stage', 'stage',        '#FF3B30', 28,  360, 170, 50),
('c0000001-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000006', 'Community Stage','stage',        '#AF52DE', 210, 360, 158, 50);
